...
class SessionAdmin(admin.ModelAdmin):
    list_display = ('city', 'district', 'customer_type', 'date', 'time', 'name_and_family', 'phone_number', 'datetime_created', 'status')
    ordering = ('-datetime_created', )


@admin.register(Visit)
class VisitAdmin(admin.ModelAdmin):
    list_display = ('city', 'district', 'date', 'time', 'name_and_family', 'phone_number', 'datetime_created', 'status')
    ordering = ('-datetime_created', )
